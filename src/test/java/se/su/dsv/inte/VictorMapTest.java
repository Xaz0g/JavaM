...
public class VictorMapTest {
    ...
    public void validDimensions() {
        m = new VictorMap(VALID_HEIGHT,VALID_WIDTH);
    ...
    public void invalidHeightZero() {
        m = new VictorMap(ZERO,VALID_WIDTH);
    }

    @Test(expected = IllegalArgumentException.class)
    public void invalidWidthZero() {
        m = new VictorMap(VALID_HEIGHT,ZERO);
    }

    @Test(expected = IllegalArgumentException.class)
    public void invalidHeightNegative() {
        m = new VictorMap(NEGATIVE,VALID_WIDTH);
    }

    @Test(expected = IllegalArgumentException.class)
    public void invalidWidthNegative() {
        m = new VictorMap(VALID_HEIGHT,NEGATIVE);
    }
    ...
    public void getPlayerCharacterNotNull() {
        m = new VictorMap(VALID_HEIGHT,VALID_WIDTH);
		PlayerCharacter pChar = new VictorPlayerCharacter();
